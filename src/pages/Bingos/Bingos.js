...
export default function MovimientosClienteBingos(props) {
  ...
  const dataSource = [
    {
        nombre: <h5 style={{color: '#701E19', textDecoration:'underline'}}>Octubre Bokados</h5>,
        ...
        m2: <p style={{color:'#8a8a8a'}}>3</p>,
        activa: <Tag color="green">1 MES RESTANTE</Tag>,
    },
    {
        nombre: <h5 style={{color: '#701E19', textDecoration:'underline'}}>Ahorra Energía con Sprite</h5>,
      ...
      >
        <Layout className="site-layout-content">
          ...
          >
            ...
            >
              <Row >
                <Col flex={12} style={{boxShadow:'box-shadow: 2px 10.32px 22.37px rgba(16, 30, 115, 0.06)', top:'-20px'}}>
                 <Navbar />
                </Col>
                <Col flex={2} style={{marginLeft:'-53em', marginTop:'0em', color:'#701E19'}}>
                  <h2>Bingos Publicados</h2>
                </Col>
              </Row>
              <Row>
                      ...
                      >
                        <div style={{ marginLeft: "45%" }}>
                          <Row style={{marginTop:'-1em'}}>
                            <Col flex={2}>
                                <AutoComplete dropdownMatchSelectWidth={252} style={{width: 750, float:'left', marginLeft:-800}} options={options} onSelect={onSelect} onSearch={handleSearch}>
